        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="block">
                        <img class="app-img img-responsive" src="<?=STATIC_FRONT_IMAGE?>app.png" alt="">
                    </div>
                ...
                <div class="col-md-6 col-md-offset-1 col-sm-6">
                    <div class="block">
                        <h1>
                            Beautiful, simple and easy UI.
                        </h1>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos nemo, corporis ipsum soluta nobis ea! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos nemo, corporis ipsum soluta nobis ea! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos nemo, corporis ipsum soluta nobis ea!
                        </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 wow fadeInLeft" data-wow-delay=".8s">
                    <div class="block">
                        <img class="img-responsive" src="<?=STATIC_FRONT_IMAGE?>featured-app.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".8s">
                    <img class="img-responsive" src="<?=STATIC_FRONT_IMAGE?>mockup.png" alt="">
                </div>
    ...
    <section id="utility-2">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 wow fadeInRight" data-wow-delay=".8s">
                    <img class="img-responsive" src="<?=STATIC_FRONT_IMAGE?>app-screen.png" alt="">
                </div>
            </div>
        </div>
    </section>
