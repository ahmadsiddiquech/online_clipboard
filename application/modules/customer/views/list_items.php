...
<div class="content-wrapper">
    <h3>List Items<a href="<?=ADMIN_BASE_URL?>customer"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;&nbsp;Back</button></a></h3>
...
$(document).ready(function(){
    ...
    var id = $(this).attr('rel');
      $.ajax({
                type: 'POST',
                url: "<?php echo ADMIN_BASE_URL?>customer/list_item_detail",
                data: {'id': id},
                async: false,
    ...
    $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
      ...
      swal({
        ...
        function () {
               $.ajax({
                    type: 'POST',
                    url: "<?php echo ADMIN_BASE_URL?>customer/delete_list_item",
                    data: {'id': id},
                    async: false,
                    success: function() {
                    location.reload();
