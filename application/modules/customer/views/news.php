                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    foreach ($news->result() as
                                            $new) {
                                        $i++;
                                        $list_url = ADMIN_BASE_URL . 'customer/lists/' . $new->id;
                                    ...
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        ...
                                        echo anchor($list_url, '<i class="fa fa-eye"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'View Lists'));
...
$(document).ready(function(){
    ...
    var id = $(this).attr('rel');
      $.ajax({
                type: 'POST',
                url: "<?php echo ADMIN_BASE_URL?>customer/detail",
                data: {'id': id},
                async: false,
